    ...
    bg-[#52b7883b]
     rounded-[16px] p-4 flex items-center ">
      <div className="grid grid-cols-12 gap-4 text-black w-full">
        ...
        <div className="custom-reverse col-span-12 lg:col-span-4 xl:col-span-3 p-4 rounded-2xl">
        ...
        <div className="custom-reverse col-span-12 lg:col-span-3 xl:col-span-3 p-4 rounded-2xl ">
        ...
        {/* <div className="col-span-12 lg:col-span-4 xl:col-span-2 bg-[#FEFAE0] p-4 rounded-2xl ">
        ...
        <div className="custom-reverse px-2 py-6 rounded-2xl flex justify-center items-center col-span-12 lg:col-span-12 xl:col-span-6">
          <Loader />
        </div>
      </div>
    </div>
