  ...
  return (
    <div className="w-full h-full flex items-center bg-[#52b7883b] rounded-[16px] p-4">
      <div className="grid grid-cols-6 grid-rows-6 w-full h-full gap-5 p-4">
        ...
        <div className="col-span-6 row-span-2 md:col-span-4 md:row-span-6 custom-reverse rounded-2xl">
          <img
        ...
        <div className="col-span-3 row-span-1 md:col-span-2 md:row-span-1 lg:col-span-1 lg:row-span-2 custom-reverse rounded-2xl flex justify-center items-center">
        ...
        <div className="col-span-3 row-span-2 md:col-span-2 md:row-span-1 lg:col-span-1 lg:row-span-2 rounded-2xl custom-reverse flex justify-center items-center">
        ...
        <div
          className="col-span-3 row-span-2 md:col-span-2 md:row-span-1 lg:col-span-1 lg:row-span-2 rounded-2xl custom-reverse flex justify-center items-center cursor-pointer"
